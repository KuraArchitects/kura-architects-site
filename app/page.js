...
{/\* Header \*/} <header className="flex items-center justify-between p-6 bg-[#7994a0]"> <Image src="/Logo.png" alt="Kura Architects" width={220} height={60} /> <nav className="space-x-6 text-white text-lg"> <a href="#about" className="hover:underline">About</a> <a href="#services" className="hover:underline">Services</a> <a href="#contact" className="hover:underline">Contact</a> </nav> </header>
...
```
  ...
  <section className="h-[85vh] flex flex-col justify-center items-center bg-gray-100 text-center">
    ...
    >
      Guiding clients through every every  stage of their project  |  From strategic brief to handover  |  With clarity, rigour and attention to detail.
    </motion.p>
  </section>
  ...
  <section id="contact" className="px-6 py-16 bg-white text-center">
    ...
    >
      ...
      <p className="text-lg">Phone: <a href="tel:+4478 11 33 12 10" className="text-[#7994a0] underline">+44 (0)78 11 33 12 10</a></p>
